...
video_id_list = video_ID.to_list()
total_videos = len(video_id_list)
progress_bar = tqdm(total=total_videos, desc="Processing Videos", unit="video")

youtube_api_key = "AIzaSyC55aTxc01kYFiT45IyPHKUBY51j90tfts"
